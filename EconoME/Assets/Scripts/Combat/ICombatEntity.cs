...
{
    /// <summary>
    /// Called when some attack makes contact with an Combatable Entity
    /// </summary>
    /// <param name="attack">The attack instance to be applied</param>
    /// <returns>Returns the damage done to the entity</returns>
