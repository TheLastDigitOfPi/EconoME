...
public class PlayerBookHandler : MonoBehaviour
{
    ...
    [field: SerializeField] public TextMeshProUGUI PlayerMoneyText { get; private set; }
    ...
    [field: SerializeField] public BookPage Backpack { get; private set; }
    [field: SerializeField] public BookPage ResourceBag { get; private set; }
    [field: SerializeField] public BookPage Status { get; private set; }
    [field: SerializeField] public BookPage Info { get; private set; }
    [field: SerializeField] public BookPage SettingsSelector { get; private set; }
    [field: SerializeField] public BookPage Graphics { get; private set; }
    [field: SerializeField] public BookPage Audio { get; private set; }
    [field: SerializeField] public BookPage Controls { get; private set; }
    [field: SerializeField] public BookPage General { get; private set; }
    ...
    {
        Flip(Info, ResourceBag);
    }
    public void FlipToBackpack()
    {
        Flip(Status, Backpack, flipRight: true);
    }
